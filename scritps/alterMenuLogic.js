		...
		navDom.innerHTML = `<ul class="navbarUl">
			...
			<div>
				<ul class="responiveLUl">
					<li><a href="https://smithmantenimiento.com/aboutUs.html"><h2 class="menuTitle">Sobre Nosotros</h2></a></li>
                    <li><a href="https://smithmantenimiento.com/services.html"><h2 class="menuTitle">Servicios</h2></a></li>
                    <li><a href="https://smithmantenimiento.com/rationalmty.html"><h2 class="menuTitle">Rational MTY</h2></a></li>
                    <li><a href="https://smithmantenimiento.com/contact.html"><h2 class="menuTitle">Contacto</h2></a></li>
				</ul>
			</div>
		</ul>`;
	}else{
		...
		<div class="acordionMenu close">
			<ul class="acordionUl">
				<li class="acordionItem noVisible">
                        <a href="https://smithmantenimiento.com/aboutUs.html">
                            <h3 class="h3Text">Sobre Nosotros</h3>
                            <div class="divisionBar"></div>
                        </a>
                    </li>
                    <li class="acordionItem noVisible">
                        <a href="https://smithmantenimiento.com/services.html">
                    ...
                    <li class="acordionItem noVisible">
                        <a href="https://smithmantenimiento.com/contact.html">
